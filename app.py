...
def cadFase():
    ...
    if request.method == 'POST' and field.validate():
        ...
        json = {'fase': fase, 'descricao': descricao,
                'finalizado': False}  # , 'eixos':[] COLOCAR DENTRO DOS COLCHETES PARA CRIAR UM ARRAY DE EIXOS
...
def cadEixo():
    ...
    if request.method == 'POST' and field.validate():
        ...
        json = {'eixo': eixo, 'descricao': descricao,
                'finalizado': False}  # , 'atividades': []    COLOCAR DENTRO DOS COLCHETES PARA CRIAR UM ARRAY DE ATIVIDADES
...
def cadEmpresa():
    ...
    if request.method == 'POST' and field.validate():
        ...
        json = {'empresa': empresa, 'descricao': descricao, 'valorF': valorF,
                'finalizado': False}  # 'fases':[],  COLOCAR NOS COLCHETES PARA CRIAR ARRAY DE FASES
...
def alterar_empresa(_id):
    ...
    if request.method == 'POST' and field.validate():
        ...
        valorF = request.form['valorF']
        json = {'empresa': empresa, 'descricao': descricao, 'valorF': valorF,
                'finalizado': False}  # , 'fases':aux['fases']   COLOCAR DENTRO DOS COLCHETES PARA COLOCAR ARRAY DE FASES
